...
async function testSideEffectField() {
    ...
    await sideEffectsField.setValue(process.env.LONG_TEXT);
    ...
    return assert.strictEqual(value, "Field cannot contain more than 1000 characters")
}

module.exports = {testSideEffectField}